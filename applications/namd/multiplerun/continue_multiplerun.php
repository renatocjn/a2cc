<?php
	...
	function run_app($params, $outdir, $connection) {
		$required_params = array('coordenatesFile', 'structureFile', 'inpFile', 'coorFile', 'velFile', 'divisions');
		...
		$connection->send_file($params['coorFile']['tmp_name'], $outdir.'namd-output0.coor');
		$connection->send_file($params['velFile']['tmp_name'], $outdir.'namd-output0.vel');
		$connection->send_file('app_assets/namd/continue_multiple_namd_script.sh', $outdir.'namd.sh');
