<?php
	...
	function run_app($params, $outdir, $connection) {
		$required_params = array('coordenatesFile', 'structureFile', 'inpFile', 'coorFile', 'velFile', 'initialStep';
		check_required_params($required_params, $params);

		$default_params = get_default_continue_namd_params();
		...
		$connection->send_file($params['coorFile']['tmp_name'], $outdir.'namd.coor');
		$connection->send_file($params['velFile']['tmp_name'], $outdir.'namd.vel');
